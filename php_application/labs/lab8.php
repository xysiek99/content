...
?>
    <div class="container">
        <div class="lab">
            ...
            <h3>Cele:</h3>
            <ul class="list-group">
                <li class="list-group-item">Wytworzenie przykładowych problemów podczas konfiguracji;</li>
                <li class="list-group-item">Zebranie logów i przechwycenie wymienionego ruchu;</li>
                <li class="list-group-item">Analiza zebranych danych;</li>
            </ul>
            </br>
            <h3>Wprowadzenie:</h3>
            <p>Podczas pracy konfiguracyjnej mogą wystąpić problemy, które trzeba zdiagnozować. Aby rozwiązać problem na samym początku należy zdefiniować i odtworzyć problem, zebrać logi i przechwycić ruch, przeanalizować zebrane dane, postawić hipotezę problemu, zrobić test postawionej hipotezy i na końcu wdrożyć rozwiązania.</p>
        </div>
        <div class="container">
            <br>
